        ...
        <form action="/users/{{ $user->id }}" method="POST" >
            ...
            <div class="bg-white py-2 px-4 sm:px-6 lg:px-8 rounded-xl text-gray-600 border border-gray-200">
                ...
                <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:py-5">
                    ...
                    <div class="mt-2 mb-4 sm:col-span-2 sm:my-0">
                        <x-input type="password" name="password" id="password" :value="$user->password" />
                    </div>
                </div>
            </div>
            <div class="pt-5">
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="ml-3 inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Update User</button>
                </div>
            </div>
        </form>    
    </div>
